...
# Split BLE
keyboard.modules.append(Split(split_type=SplitType.BLE, split_side=SplitSide.LEFT))
...
def oled_update(kbd):
    oled.fill(0)
    oled.text(f"Layer: {kbd.current_layer}",0,0)
...
# Keymap
keys = [
    KC.N1, KC.N2, KC.N3, KC.N4, KC.N5, KC.TAB, KC.ESC, KC.GRAVE,
    ...
    KC.NO, KC.NO, KC.LCTRL, KC.LALT, KC.LSHIFT, KC.SPACE, KC.BSPACE, KC.ENTER
]
